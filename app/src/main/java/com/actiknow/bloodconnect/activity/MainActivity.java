...
import com.actiknow.bloodconnect.fragment.HomeFragment;
import com.actiknow.bloodconnect.utils.Constants;
import com.actiknow.bloodconnect.utils.LoginDetailsPref;
...
//                .withItemAnimator (new AlphaCrossFadeAnimator ())
                .addDrawerItems (
                        ...
                        new PrimaryDrawerItem ().withName ("My Profile").withIcon (FontAwesome.Icon.faw_user).withIdentifier (5).withSetSelected (false).withSelectable (false),
                        new PrimaryDrawerItem ().withName ("Notification Center").withIcon (FontAwesome.Icon.faw_cog).withIdentifier (4).withSetSelected (false).withSelectable (false),
                        new PrimaryDrawerItem ().withName (R.string.drawer_item_support).withIcon (FontAwesome.Icon.faw_question_circle).withIdentifier (6).withSelectable (false).withSetSelected (false),
                        new PrimaryDrawerItem ().withName ("Contact Us").withIcon (FontAwesome.Icon.faw_phone).withIdentifier (7).withSetSelected (false).withSelectable (false),
                    ...
                    public boolean onItemClick (View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch ((int) drawerItem.getIdentifier ()) {
                            case 1:
                                ...
                                break;
                            case 5:
                                s = new SpannableString (actionBar.getTitle ());
